...
const Press = () => {
  ...
  return (
    <PageLayout 
      title="Press & Media" 
      description="The latest news, press releases, and media coverage about Ruvo."
    >
            ...
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1">
                  ...
                  <p className="mt-2">
                    <strong>Email:</strong> <a href="mailto:press@ruvo.ai" className="text-ruvo-500 hover:underline">press@ruvo.ai</a>
                  </p>
                  <p>
