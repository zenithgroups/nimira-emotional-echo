          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="max-w-md mx-auto space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="block text-sm font-medium text-gray-200 mb-1">Name</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="block text-sm font-medium text-gray-200 mb-1">Email</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        type="email"
