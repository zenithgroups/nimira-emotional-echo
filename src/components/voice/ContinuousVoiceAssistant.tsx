...
export const ContinuousVoiceAssistant: React.FC<ContinuousVoiceAssistantProps> = ({
  isOpen,
  onClose,
  darkMode,
  userData,
      ...
      <div className={cn(
            ...
            {transcript && (
              <div className="mb-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium opacity-60 mb-1">You said:</p>
                    <p className={cn("text-sm", darkMode ? "text-slate-100" : "text-gray-800")}>
                      {transcript}
                    </p>
                  </div>
                </div>
        ...
        {conversationHistory.length > 0 && (
          <div className={cn(
            ...
            <p className="text-xs font-medium opacity-60 mb-2">Conversation History:</p>
        ...
        <div className="text-center mt-6">
          <div className={cn(
            ...
            {isConversationActive && state !== 'error' && (
              <span className="text-xs opacity-60">• Continuous mode active</span>
            )}
          </div>
        </div>
