      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">About Nimira</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-600 mb-4">
                At Nimira, we believe that technology should enhance human connection, not replace it. 
            ...
            <div className="order-1 md:order-2">
              <div className="aspect-square bg-gradient-to-br from-nimira-100 to-nimira-200 rounded-3xl flex items-center justify-center p-8 shadow-lg">
                <div className="glass p-6 rounded-2xl max-w-xs">
                  <p className="italic text-gray-700 mb-4">
                    "We created Nimira to be more than just an AI – we wanted to build a companion 
                    that truly understands the nuances of human emotion and can provide comfort and 
                    insight when you need it most."
                  </p>
                  
                  <p className="text-right text-nimira-500 font-medium">
                    – Founder's Vision
                  </p>
                </div>
              </div>
          ...
          <div className="mt-16 border-t border-gray-100 pt-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-nimira-400 mb-2">92%</div>
                <p className="text-gray-600">Users report feeling less lonely after regular interactions</p>
              </div>
              
              <div className="text-center">
                <div className="text-4xl font-bold text-nimira-400 mb-2">24/7</div>
                <p className="text-gray-600">Continuous emotional support whenever you need it</p>
              </div>
              
              <div className="text-center">
                <div className="text-4xl font-bold text-nimira-400 mb-2">100%</div>
