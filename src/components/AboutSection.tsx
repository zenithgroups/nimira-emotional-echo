        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 animate-slide-in-left">
              ...
              <p className="text-gray-300 mb-4 leading-relaxed">
                At RUVO, we believe that technology should enhance human
                connection, not replace it. Our mission is to develop AI
                companions that provide genuine emotional support and
                understanding, helping to reduce loneliness and improve mental
                well-being in our increasingly digital world.
              </p>

              <p className="text-gray-300 mb-6 leading-relaxed">
                We're committed to responsible AI development, prioritizing user
                privacy, emotional safety, and creating technology that serves
                genuine human needs for connection and understanding.
              </p>
              ...
              <div className="aspect-square bg-gradient-to-br from-white/5 to-white/10 rounded-3xl flex items-center justify-center p-8 shadow-lg relative overflow-hidden">
                ...
                <div className="card-glass p-6 rounded-2xl max-w-xs relative">
                  <p className="italic text-gray-300 mb-4 leading-relaxed">
                    "We created RUVO to be more than just an AI – we wanted to
                    build a companion that truly understands the nuances of
                    human emotion and can provide comfort and insight when you
                    need it most."
                  </p>
          ...
          <div className="mt-16 border-t border-white/20 pt-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div
                className="text-center card-glass p-6 rounded-xl transition-all duration-300 animate-fade-up"
              ...
              >
                ...
                <p className="text-gray-300">
                  Users report feeling less lonely after regular interactions
                </p>
              </div>
              ...
              >
                ...
                <p className="text-gray-300">
                  Continuous emotional support whenever you need it
                </p>
              </div>
