      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-16 animate-fade-up">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm mb-8">
            ...
            <span className="text-xs font-medium text-white/80">Powerful AI Features</span>
          </div>
          ...
          <div className="order-1 lg:order-2 animate-slide-in-right">
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-white group-hover:text-orange-300 transition-colors duration-300">Real-time Chat with OpenAI</h3>
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-bold mb-3 text-white group-hover:text-orange-300 transition-colors duration-300">Daily Mood Check-ins</h3>
                  <p className="text-gray-300 leading-relaxed">
