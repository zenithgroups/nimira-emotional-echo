          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Your emotional AI companion, designed to understand and support
                you with empathy and intelligence.
              </p>
          ...
          <div className="pt-8 border-t border-white/20">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-500 text-sm mb-4 md:mb-0">
                &copy; {currentYear} RUVO AI. All rights reserved.
              </p>
              <div className="flex space-x-8">
                <Link
                  to="/privacy-policy"
                  className="text-gray-500 text-sm hover:text-orange-400 transition-colors duration-300"
                >
                  Privacy Policy
                </Link>
                <Link
